...
def get_weights_and_info_from_hugging(hugging_face_model):
    """
    ...
    # Load weights
    # TODO: checkar se este ficheiro é igual ao model_weights.pth e se for, porque nao dar-lhe o mesmo nome?
    weights_pth = os.path.join(local_dir, 'pytorch_model.bin')
...
class Architecture(pl.LightningModule):
    ...
    def test_on_single_signal(self, X, checkpoints_dir=None, gpu_id=None):
        """
