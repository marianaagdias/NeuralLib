import itertools
import architectures.biosignals_architectures as arc
from data_preprocessing.gib01 import X, Y_BIN
from config import RESULTS_PEAK_DETECTION
from architectures.base import get_hparams_from_checkpoints, get_hparams_from_hugging, validate_training_context
...
if __name__ == "__main__":
    ...
    best_dir, best_val_loss, val_losses = run_grid_search(architecture_name_, architecture_params_options_,
                                                          train_params_, retrain=False)

    run_grid_search(architecture_name_, architecture_params_options_, train_params_, retrain=True,
                    checkpoints_directory=best_dir)
